...
class Donation(models.Model):
    ...
    def action_send_thanks(self):
        ...
        compose_form = self.env.ref(
            "donation_letter.donation_letter_send_wizard_form", raise_if_not_found=False
        )
        ctx = {
    ...
    def action_donation_print(self):
        ...
        """
        self.filtered(lambda inv: not inv.is_thanks_letter_send).write(
            {"is_thanks_letter_send": True}
        )
    ...
    def _get_mail_template(self):
        ...
        """
        return "donation_letter.email_template_thanks_letter"
